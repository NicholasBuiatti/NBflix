    ...
    return (
        <>
            ...
            <div className='py-3'>
                ...
                <ul>
                    <li className='sm:pl-12 hover:border-l-orange-600 hover:border-l-2'>Friends</li>
                    <li className='sm:pl-12 hover:border-l-orange-600 hover:border-l-2'>Parties</li>
                </ul>
            </div>
            <div className='py-3'>
                <p className='pb-3 sm:pl-6 text-gray-600 dark:text-gray-400'>General</p>
                <ul>
                    <li className='sm:pl-12 hover:border-l-orange-600 hover:border-l-2'>Settings</li>
                    <li className='sm:pl-12 hover:border-l-orange-600 hover:border-l-2'>Log out</li>
                </ul>
            </div>
        </>
    )
